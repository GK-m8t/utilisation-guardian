...
export default function ConsentPage() {
  ...
  const bufferShare = state.bank.safetyBuffer / bank;
  const moveShare = facts.affordableNow / bank;
    ...
    <div className="flex flex-col gap-6">
      ...
      <header className="rise" style={{ "--d": "0.06s" } as React.CSSProperties}>
        ...
        <p className="mt-2 text-[13.5px] leading-relaxed text-mute">
          The full {facts.display.paydownTo30} today would cut into money you need
          before salary. So the plan splits it.
        </p>
      </header>
